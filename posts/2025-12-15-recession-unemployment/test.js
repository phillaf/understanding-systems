// Test for recession-unemployment blog post
const fs = require('fs');
const path = require('path');
const { JSDOM } = require('jsdom');

console.log('=== Testing recession-unemployment post ===\n');
...
const requiredDataFiles = [
    ...
    'data/transformed/gdp_log_diff.js',
    'data/transformed/unemployment_gdp_analysis.js'
];
...
const requiredElements = [
    { id: 'gdpChart', type: 'canvas' },
    { id: 'unemploymentChart', type: 'canvas' },
    { id: 'okunChart', type: 'canvas' },
    { id: 'rollingCorrelationChart', type: 'canvas' },
    { id: 'crossCorrelationChart', type: 'canvas' },
    { id: 'grangerU2GChart', type: 'canvas' },
    { id: 'grangerG2UChart', type: 'canvas' },
    { id: 'coherenceChart', type: 'canvas' },
    { id: 'correlationChart', type: 'canvas' }
];
